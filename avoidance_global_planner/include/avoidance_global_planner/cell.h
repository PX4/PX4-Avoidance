#ifndef AVOIDANCE_GLOBAL_PLANNER_CELL
#define AVOIDANCE_GLOBAL_PLANNER_CELL
...
template <>
struct hash<avoidance_global_planner::Cell> {
  std::size_t operator()(const avoidance_global_planner::Cell& cell) const {
...
#endif  // AVOIDANCE_GLOBAL_PLANNER_CELL
