...
PathHandlerNode::PathHandlerNode() {
  ...
  dynamic_reconfigure::Server<
      avoidance_global_planner::PathHandlerNodeConfig>::CallbackType f;
  ...
  three_point_msg_publisher_ =
      nh_.advertise<avoidance_global_planner::ThreePointMsg>("/three_point_msg", 10);
...
void PathHandlerNode::dynamicReconfigureCallback(
    avoidance_global_planner::PathHandlerNodeConfig& config, uint32_t level) {
...
int main(int argc, char** argv) {
  ...
  avoidance_global_planner::PathHandlerNode path_handler_node;
  ros::spin();
  return 0;
}
