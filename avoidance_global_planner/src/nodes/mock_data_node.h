#ifndef AVOIDANCE_GLOBAL_PLANNER_MOCK_DATA_NODE_H
#define AVOIDANCE_GLOBAL_PLANNER_MOCK_DATA_NODE_H
...
#include "avoidance_global_planner/common.h"  // hasSameYawAndAltitude
