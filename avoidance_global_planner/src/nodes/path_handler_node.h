...
#include <avoidance_global_planner/PathHandlerNodeConfig.h>
...
#include <avoidance_global_planner/ThreePointMsg.h>
...
class PathHandlerNode {
 ...
 private:
  ros::NodeHandle nh_;
  dynamic_reconfigure::Server<avoidance_global_planner::PathHandlerNodeConfig> server_;
  ...
  // Callbacks
  void dynamicReconfigureCallback(avoidance_global_planner::PathHandlerNodeConfig& config,
                                  uint32_t level);
