...
#include "avoidance_global_planner/avoidance_global_planner.h"
...
class GlobalPlannerNode {
 ...
 private:
  ros::NodeHandle nh_;
  dynamic_reconfigure::Server<avoidance_global_planner::GlobalPlannerNodeConfig> server_;
  ...
  void dynamicReconfigureCallback(
      avoidance_global_planner::GlobalPlannerNodeConfig& config, uint32_t level);
