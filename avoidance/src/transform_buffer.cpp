...
std::string TransformBuffer::get_key(const std::string& source_frame,
                                     const std::string& target_frame) const {
  return source_frame + "_to_" + target_frame;
}

bool TransformBuffer::interpolateTransform(
    const tf::StampedTransform& tf_earlier,
...
bool TransformBuffer::isRegistered(const std::string& source_frame,
                                   const std::string& target_frame) const {
  std::unordered_map<
      std::string, std::deque<tf::StampedTransform>>::const_iterator iterator =
...
void TransformBuffer::registerTransform(const std::string& source_frame,
...
bool TransformBuffer::insertTransform(const std::string& source_frame,
                                      const std::string& target_frame,
...
bool TransformBuffer::getTransform(const std::string& source_frame,
                                   const std::string& target_frame,
                                   ros::Time time,
                                   tf::StampedTransform& transform) const {
  std::lock_guard<std::mutex> lck(*mutex_);
