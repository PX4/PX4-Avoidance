...
GlobalPlannerNode::GlobalPlannerNode()
{
    ...
    // Subscribers
    octomap_full_sub_ = nh_.subscribe("/octomap_full", 1, &GlobalPlannerNode::octomapFullCallback,
                                      this);
    ...
    clicked_point_sub_ = nh_.subscribe("/clicked_point", 1, &GlobalPlannerNode::clickedPointCallback,
                                       this);
    three_point_sub_ = nh_.subscribe("/three_points", 1, &GlobalPlannerNode::threePointCallback, this);
    move_base_simple_sub_ = nh_.subscribe("/move_base_simple/goal", 1,
    ...
    depth_camera_sub_ = nh_.subscribe("/camera/depth/points", 1,
