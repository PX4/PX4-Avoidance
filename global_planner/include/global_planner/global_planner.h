...
public:
    ...
    heuristic_cache_;  // Cache of getHeuristic(Node) (and later reverse search)
    double bubble_cost_ =
        0.0;  // Minimum risk for the safest path from a cell outside of the bubble to t
    ...
    double vert_to_hor_cost_ =
        1.0;     // The cost of changing between vertical and horizontal motion (TODO: use it)
